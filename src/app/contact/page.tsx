    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <div className="space-y-8">
        <div className="relative flex items-center justify-center mb-12">
          ...
          <h1 className="text-4xl md:text-4xl font-bold">Contact</h1>
        </div>
        ...
        >
          ...
          <div className="space-y-6">
            <motion.a
              ...
              className="group block p-6 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-slate-600/70 transition-all duration-300 hover:bg-slate-800/50"
            >
              ...
              <p className="mt-2 text-slate-400 group-hover:text-slate-300 transition-colors">
                james@sighttrack.org
              </p>
            </motion.a>

            <motion.a
              href="https://www.linkedin.com/in/james-tan-74048a354/"
              target="_blank"
